...
if [ $# -lt 2 ]; then
	echo "Breach-parse V2: A tool developed by Olalekan Ilori"
	echo " "
	echo "usage: ./breach-parse <domain to search> <file to output> [breach data location]"
	echo "Example: ./breach-parse @gmail.com gmail.txt"
	echo 'Example: ./breach-parse @gmail.com gmail.txt "~/Downloads/BreachCompilation/date"'
